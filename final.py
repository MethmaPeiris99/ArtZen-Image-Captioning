...
image_folder_directory = r"C:\Users\USER\Downloads\retinanet_resnet50_fpn_coco-eeacb38b\test-paintings"
...
with open('wikiart-captions.csv', 'w') as wikiArtCaptionFile:
    ...
    for image in os.listdir(image_folder_directory):
        ...
        image_captions = [image_file_name, detected_colour_names, set(detectedObjects)]
        print(image_captions, "\n")

        csvWriter.writerow(image_captions)
    print("END")
